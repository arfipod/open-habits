...
describe('component interactions', () => {
  it('edits numerical habit fields and deletes through HabitForm', async () => {
    ...
    await user.type(screen.getByLabelText('Times'), '3')
    await user.clear(screen.getByLabelText('Period count'))
    await user.type(screen.getByLabelText('Period count'), '1')
    await user.selectOptions(screen.getByLabelText('Period unit'), 'weeks')
